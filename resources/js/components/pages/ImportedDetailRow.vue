        ...
        <div class="field">
            <div class="row">
                ...
                <div class="col-md-3" v-if="rowData.last_claim_days">
                    <p class="no-margin"><b>Last Claim Days: </b> {{ rowData.last_claim_days }}
                    <span v-if="rowData.last_claim_days > 1"> days</span>
                    <span v-else> day</span>
                    </p>
                </div>
                <div class="col-md-3" v-if="rowData.last_claim_date">
